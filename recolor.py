...
class Core:
    ...
    @staticmethod
    def simulate(input_path: str, simulate_type: str = 'protanopia', simulate_degree_primary: float = 1.0, simulate_degree_sec: float = 1.0, return_type: str = 'save', save_path: str = None):
        """
...
def main():
    ...
    print('Color For All completed running! Check output images in {}'.format(output_path))
